...
| Q | تبديل الجودة | Q | Quality Toggle |
| 🔄 | تصحيح الاتجاه | 🔄 | Flip Video |
...
## 🆕 الجديد في v1.1.0 | What's New in v1.1.0

### 🔄 **إصلاح الانقلاب | Flip Fix**
- **زر تصحيح الاتجاه** 🔄 - 4 أوضاع مختلفة
- **إصلاح مشكلة الفيديو المقلوب** - حل شامل
- **تبديل سريع بين الأوضاع** - عادي، أفقي، رأسي، كامل

### 🎯 **تحسينات الجودة | Quality Enhancements**
- **مؤشر جودة مباشر** 📊 - معلومات الفيديو والأداء
- **3 مستويات جودة** - عالية 💎، متوسطة 🎯، سريعة ⚡
- **تحسين دقة الكرة** - من 60x40 إلى 128x64 segments
- **Anti-aliasing محسن** - رسومات أكثر نعومة

### ⚡ **تحسينات الأداء | Performance Improvements**
- **WebGL متقدم** - استخدام أمثل للمعالج الرسومي
- **Pixel Ratio ذكي** - تحسين للشاشات عالية الدقة
- **إدارة الذاكرة** - استهلاك أقل وأداء أفضل
- **Color Management** - ألوان أكثر دقة
